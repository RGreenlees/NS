...
public:
	...
	/// Sets the include flags for the filter.
/// @param[in]		flags	The new flags.
	inline void removeIncludeFlags(const unsigned int flags) { m_includeFlags = m_includeFlags & ~flags; }
...
/// @param[in]		flags	The new flags.
	...
	/// Sets the include flags for the filter.
/// @param[in]		flags	The new flags.
	inline void removeExcludeFlags(const unsigned int flags) { m_excludeFlags = m_excludeFlags & ~flags; }
